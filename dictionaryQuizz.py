# Pregunta 1
# La función email_list recibe un diccionario, que contiene nombres de dominio como claves y una lista de usuarios como valores.
#  Complete los espacios en blanco para generar una lista que contenga direcciones de correo electrónico completas (por ejemplo, diana.prince@gmail.com).
